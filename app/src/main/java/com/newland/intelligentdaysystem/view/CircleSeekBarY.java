...
public class CircleSeekBarY extends View {
    ...
    public double mAngleYMin = 0;
    public double mAngleYMax = 0;

    public CircleSeekBarY(Context context) {
        this(context, null);
    }

    public CircleSeekBarY(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleSeekBarY(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            if (mChangListener != null && (event.getAction() & (MotionEvent.ACTION_MOVE | MotionEvent.ACTION_UP)) > 0) {
    ...
    public interface OnSeekBarChangeListener {
        void onChanged(CircleSeekBarY seekbar, int curValue);
        void onChangedFinish(CircleSeekBarY seekbar, int curValue);
    }
}
